...
namespace Sjs.Common
{
    ...
    public abstract class PageTemplate
    {
        ...
        /// 如果读取文件成功则会将内容放于缓存中.
        /// </summary>
        /// <param name="forumpath">模板文件夹templates的前导路径</param>
        ...
        public virtual string GetTemplate(string forumpath, string skinName, string templateName, int nest, int templateid)
        {
            ...
            if (nest == 1)
            {
                ...
                string template = string.Format("<%@ Page language=\"c#\" Codebehind=\"{0}.aspx.cs\" AutoEventWireup=\"false\" EnableViewState=\"false\" Inherits=\"SJSCAN.WebPage.{0}\" %>\r\n<%@ Import namespace=\"System.Data\" %>\r\n<%@ Import namespace=\"Sjs.Common\" %>\r\n<%@ Import namespace=\"SJSCAN.Entity\" %>\r\n{1}\r\n<script runat=\"server\">\r\nprotected override void OnInit(EventArgs e)\r\n{{\r\n\r\n\t/* \r\n\t\tThis page was created by Su jinshui Template Engine at {2}.\r\n\t\t本页面代码由--苏金水--的模板引擎生成于 {2}. \r\n\t*/\r\n\r\n\tbase.OnInit(e);\r\n{3}\r\n\tResponse.Write(templateBuilder.ToString());\r\n}}\r\n</script>\r\n", templateName, extNamespace, DateTime.Now.ToString(), strReturn.ToString());
