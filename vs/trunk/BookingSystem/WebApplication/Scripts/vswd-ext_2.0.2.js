...
Ext.Updater.update = function(el, url, params, options) {
}
...
Ext.UpdateManager.update = function(el, url, params, options) {
}
...
Ext.dd.DragDropMgr = {
	...
	/// <param name="oDD" type="oDD|the|DragDrop|object|being|dragged"/>
	},
	...
	getPosX : function(el) {
	/// <param name="el" type="el|the|element|for|which|to|get|the|position"/>
	/// <returns type="int" />
	},
	getPosY : function(el) {
	/// <param name="el" type="el|the|element|for|which|to|get|the|position"/>
	...
	/// <param name="n1" type="n1|the|first|node|to|swap"/>
	/// <param name="n2" type="n2|the|other|node|to|swap"/>
	},
	getScroll : function() {	},
	...
	/// <param name="node" type="node|the|html|element|to|inspect"/>
	}
}
...
Ext.form.HtmlEditor = function() {}

Ext.form.TimeField = function(config) {
	/// <param name="config" type="Object"/>
}

Ext.form.Label = function() {}
...
Ext.Element.prototype = {
	...
	/// <param name="visMode" type="visMode|Element.VISIBILITY|Element.DISPLAY"/>
	/// <returns type="Ext.Element" />
	},
	...
	/// <param name="params" type="String|Object" optional="true"/>
	/// <param name="callback" type="Function" optional="true"/>
	/// <param name="discardUrl" type="Boolean" optional="true"/>
	/// <returns type="Ext.Element" />
	},
	getUpdater : function() {
	...
	/// <param name="className" type="String"/>
	/// <param name="preventFlicker" type="Boolean" optional="true"/>
	/// <returns type="Ext.Element" />
	},
...
Ext.UpdateManager.prototype.startAutoRefresh = function(interval, url, params, callback, refreshNow) {
	...
	/// <param name="url" type="String|Function" optional="true"/>
	/// <param name="params" type="String|Object" optional="true"/>
	/// <param name="callback" type="Function" optional="true"/>
...
Ext.UpdateManager.prototype.prepareUrl = function(url) {
}
...
Ext.UpdateManager.prototype.el = null;
Ext.UpdateManager.prototype.defaultUrl = null;
Ext.UpdateManager.prototype.sslBlankUrl = null;
Ext.UpdateManager.prototype.disableCaching = null;
Ext.UpdateManager.prototype.indicatorText = null;
Ext.UpdateManager.prototype.showLoadIndicator = null;
Ext.UpdateManager.prototype.timeout = null;
Ext.UpdateManager.prototype.loadScripts = null;
Ext.UpdateManager.prototype.transaction = null;
Ext.UpdateManager.prototype.autoRefreshProcId = null;
Ext.UpdateManager.prototype.refreshDelegate = null;
Ext.UpdateManager.prototype.updateDelegate = null;
Ext.UpdateManager.prototype.formUpdateDelegate = null;
...
Ext.XTemplate.prototype.apply = function(values) {
}
...
Ext.dd.DragDrop.prototype = {
	...
	/// <param name="id" type="id|the|id|of|the|linked|element"/>
	/// <param name="sGroup" type="String"/>
	/// <param name="config" type="object"/>
	},
	...
	/// <param name="id" type="id|the|id|of|the|element|that|will|be|used|to|initiate|the|drag"/>
	},
	unreg : function() {	},
	destroy : function() {	},
	isLocked : function() {
...
Ext.dd.DD.prototype.cachePosition = function(iPageX, iPageY) {
	/// <param name="iPageX" type="position"/>
	/// <param name="iPageY" type="position"/>
}
...
Ext.Container.prototype.onDestroy = function() {}
...
Ext.Panel.prototype.onDestroy = function() {}
...
Ext.Panel.prototype.setTitle = function(title, iconCls) {
	/// <param name="title" type="String"/>
	/// <param name="iconCls" type="String"/>
}
...
Ext.DatePicker.prototype.update = function(date) {
}
...
Ext.tree.TreeNode.prototype.appendChild = function() {}
...
Ext.tree.TreeLoader.prototype.requestMethod = null;
...
Ext.menu.TextItem.prototype.text = null;
...
Ext.form.DateField.prototype.disabledDays = null;
Ext.form.DateField.prototype.disabledDaysText = "";
Ext.form.DateField.prototype.disabledDates = null;
Ext.form.DateField.prototype.disabledDatesText = "";
Ext.form.DateField.prototype.minValue = null;
Ext.form.DateField.prototype.maxValue = null;
...
Ext.form.Checkbox.prototype.focusClass = null;
Ext.form.Checkbox.prototype.fieldClass = "";
...
Ext.form.Checkbox.prototype.onClick = function() {}
...
Ext.grid.HeaderDragZone.prototype.ddGroup = null;
...
Ext.grid.HeaderDropZone.prototype.ddGroup = null;
...
Ext.grid.DefaultColumnModel.prototype.setDataIndex = function(col, dataIndex) {
	/// <param name="col" type="Number"/>
	/// <param name="dataIndex" type="Number"/>
}
...
Ext.dd.DragDropMgr.initalized = false;
