...
namespace Sjs.Common
{
    ...
    public class Utils
    {
        ...
        /// <param name="stringarray">用分隔符分隔的字符串数组</param>
        ...
        /// 自定义的替换字符串函数
        /// </summary>
        /// <param name="SourceString">要修改的字符串</param>
        /// <param name="SearchString">要匹配的正则表达式模式</param>
        /// <param name="ReplaceString">要替换的字符</param>
        /// <param name="IsCaseInsensetive">RegexOption 枚举的按位"或"组合</param>
        /// <returns></returns>
        ...
        /// 生成指定数量的html空格符号
        /// </summary>
        /// <param name="nSpaces">html空格符号的数量(全角空格)</param>
        /// <returns></returns>
        ...
        /// 生成指定数量的符号
        /// </summary>
        /// <param name="nChars">符号的数量(英文半角)</param>
        /// <returns></returns>
        ...
        /// 清理字符串
        /// </summary>
        /// <param name="strIn">要清理的字符串</param>
        /// <returns></returns>
        ...
        /// <param name="replacestr">当日期为1900-01-01时,替换的字符串</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// 返回当前标准时间格式string(yyyy-MM-dd HH:mm:ss)
        /// </summary>
        ...
        /// <summary>
        /// 返回相对于当前时间的相对天数的时间日期(yyyy-MM-dd HH:mm:ss)
        /// </summary>
        ...
        /// <summary>
        /// 返回当前标准时间格式string(yyyy-MM-dd HH:mm:ss:fffffff)
        /// </summary>
        ...
        /// 返回标准时间
        /// </summary>
        /// <param name="fDateTime">指定的时间日期</param>
        ...
        /// </summary>
        /// <param name="time">指定时间</param>
        /// <param name="minutes">指定时间的领衔量</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="time">指定时间</param>
        /// <param name="hours">指定时间的领衔量</param>
        /// <returns></returns>
        ...
        /// <param name="iparray">限定的IP数组范围</param>
        /// <returns></returns>
        ...
        /// <param name="strValue">值</param>
        /// <param name="expires">过期时间(分钟)</param>
        /// <param name="datepart">过期时间(日期时间部分)</param>
        ...
        /// <summary>
        /// 判断字符串是否为null值或string.Empty
        /// </summary>
        /// <param name="str">字符串</param>
        /// <returns>字符串是否为null值或string.Empty的结果</returns>
        ...
        /// <summary>
        /// 判断Hashtable中的所有值是否为email,或IP,或Timesect
        /// </summary>
        /// <param name="NewHash"></param>
        /// <param name="ruletype">判断类型(email,或IP,或Timesect)</param>
        /// <param name="key">出错时的输出参数</param>
        /// <returns></returns>
        ...
        /// <param name="backupFileName">备份文件名</param>
        /// <param name="targetFileName">要恢复的文件名</param>
        /// <param name="backupTargetFileName">要恢复文件再次备份的名称,如果为null,则</param>
        /// <returns>操作是否成功</returns>
