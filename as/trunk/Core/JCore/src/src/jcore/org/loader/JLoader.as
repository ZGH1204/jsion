package jcore.org.loader
{
	...
	import jcore.org.events.JLoaderProgressEvent;
	
	import jutils.org.util.ObjectUtil;
	...
	public class JLoader extends EventDispatcher implements ILoader, IDispose
	{
		...
		protected function onBytesTotalProgressHandler(e:ProgressEvent):void
		{
			...
			//ed.removeEventListener(ProgressEvent.PROGRESS, onBytesTotalProgressHandler);
