package jsion.ui.components.containers
{
	...
	public class TitleBar implements ITitleBar
	{
		...
		public function getSize():IntDimension
		{
			...
			else return UIUtil.computeStringSizeWithFont(font, text);
		}
		...
		public function setTitle(title:String):void
		{
			...
			var textSize:IntDimension = UIUtil.computeStringSizeWithFont(font, title);
			var textRect:IntRectangle = new IntRectangle();
			textRect.setSize(textSize);
			
			UIUtil.layoutPosition(viewRect, textHAlign, textVAlign, textHGap, textVGap, textRect);
