package jcore.org.message
{
	...
	{
		private static var monitor:MessageMonitorImp = new MessageMonitorImp();
		 ...
		 * 
		 */		
		public static function sendMessage(msg:Message):Dictionary
		{
		 ...
		 * 
		 */		
		public static function postMessage(msg:Message):void
		{
		 ...
		 * 
		 */		
		public static function createMsg(msg:uint, sender:String, receivers:Array = null, wParam:Object = null, lParam:Object = null):Message
		{
		 ...
		 * @return 已发送的消息对象
		 */		
		public static function createAndPostMsg(msg:uint, sender:String, receivers:Array = null, wParam:Object = null, lParam:Object = null):Message
		{
