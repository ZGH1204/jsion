package jcore.org.message
{
	...
	public class DefaultSubReceiver implements IMsgReceiver, IDispose
	{
		...
		public function DefaultSubReceiver()
		{
			
		}
		
		final internal function setIdAndMonitor(subID:String, msgMonitor:MessageMonitorImp):void
		{
