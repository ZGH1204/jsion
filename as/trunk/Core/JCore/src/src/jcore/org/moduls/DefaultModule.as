package jcore.org.moduls
{
	...
	public class DefaultModule implements IMsgReceiver, IDispose
	{
		...
		public function registeSubModule(subID:String, subModuleCls:Class):void
		{
			...
			var sub:DefaultSubModule = new subModuleCls(subID, _subsMsgMonitor);
		...
		public function dispose():void
		{
			...
			if(_moduleInfo) MessageMonitor.removeReceiver(_moduleInfo.id);
