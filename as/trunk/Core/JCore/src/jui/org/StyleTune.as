package jui.org
{
	...
	public class StyleTune
	{
		 ...
		 */
		public function getCLight(c:JColor):JColor
		{
		 ...
		 */
		public function getCDark(c:JColor):JColor
		{
			return c.changeLuminance(c.getLuminance() - (cGradient / 2));
		}
		 ...
		 */
		public function getBLight(c:JColor):JColor
		{
		 ...
		 */
		public function getBDark(c:JColor):JColor
		{
			return c.changeLuminance(c.getLuminance() - (bGradient / 2) + bOffset);
		}
