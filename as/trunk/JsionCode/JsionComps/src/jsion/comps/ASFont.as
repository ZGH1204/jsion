...
package jsion.comps
{
	 ...
	 * @author iiley
	 */
	public class ASFont implements IDispose
	{
		 ...
		 */
		public function ASFont(nameOrTextFormat:* = null, size:Object = null, bold:Object = null, italic:Object = null, underline:Object = null, align:String = null, embedFontsOrAdvancedPros:* = null)
		{
		...
		{
			return new ASFont(textFormat, 11, false, false, false, null, advPro);
		}
		...
		public function changeName(name:String):ASFont
		{
			...
			tf.font = name;
			return new ASFont(tf, 0, false, false, false, null, advancedProperties);
		}
		...
		{
			return CompUtil.computeStringSizeWithFont(this, text, includeGutters);
		}
		...
		{
			return new ASFont(textFormat, 0, false, false, false, null, advancedProperties);
		}
		...
		public function takeover(oldF:ASFont):ASFont
		{
			...
			return new ASFont(newTextFormat, 0, false, false, false, null, advP);
		}
