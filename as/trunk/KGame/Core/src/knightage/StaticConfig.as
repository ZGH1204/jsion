package knightage
{
	public class StaticConfig
	{
		 ...
		 * 酒馆举行派对价格列表
		 */		
		public static const PartyPrice:Array = [0, 500, 800, 1200, 1500, 2000, 2500, 3500];
		
		/**
		 * 酒馆豪华派对价格列表
		 */		
		public static const GrandPartyPrice:Array = [0, 10, 30, 60, 100, 150, 210, 280];
		
		/**
		 * 声望升级经验
		 */		
		public static const PrestigeUpgradeExp:Array = [0, 10, 50, 200, 510, 1000, 2500, 7000];
	}
}