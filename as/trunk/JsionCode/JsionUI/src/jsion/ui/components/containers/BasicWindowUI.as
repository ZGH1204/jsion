package jsion.ui.components.containers
{
	...
	import jsion.ui.components.buttons.ImageButton;
...
//		}
		...
		protected function paintTitleBar(component:Component, bounds:IntRectangle):void
		{
			...
			if(win.titleBar)
			{
				...
				if(win.titleBar)
				{
					...
					UIUtil.layoutPosition(viewRect, win.hTitleAlign, win.vTitleAlign, win.hTitleGap, win.vTitleGap, titleRect);
		...
		protected function paintCloseButton(component:Component, bounds:IntRectangle):void
		{
			...
			if(win.closeBtn)
			{
				...
				UIUtil.layoutPosition(viewRect, win.hCloseAlign, win.vCloseAlign, win.hCloseGap, win.vCloseGap, closeRect);
